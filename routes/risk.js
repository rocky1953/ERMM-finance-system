...
router.get('/', async (req, res) => {
    try {
        ...
        let sql = 'SELECT uid, bu_no, YYYY_MM, Z_score, Z2_score, Z3_score, BZ_model, JZ_model, wall_mode, risk_color, current_ratio, quick_ratio, debt_ratio, ROA, ROE, gross_margin, net_margin FROM MGM_finance_summary WHERE 1=1';
        const params = [];
